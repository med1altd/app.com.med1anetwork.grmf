...
function functionWithHTTPResult(result) {
  try {
    ...
    return JSON.stringify({
      ...
      licenseServerUrl: licenseServerUrl,  // Widevine License URL
      drmSystem: licenseServerUrl ? "widevine" : null, // Set drmSystem only if license URL exists
      enabledDRM: licenseServerUrl !== null, // DRM enabled if Widevine URL exists
      requiredHeaders: false
    });
